...
static void adjustColor(cv::Mat& img, double strength)
{
    ...
    // L ���ӣ�[-s, +s] ƫ�����������ȣ��̰߳�ȫ��thread_local ������棩
                             ...
                             const Config& config)
{
    ...
    // 自动推导输出 tile：横幅 → 320×180，竖幅/方形 → 180×320
    ...
    // ��߱�У�飺DB �����ռ� vs ��� tile������ featW/featH ����֮��
    ...
    std::deque<std::vector<float>> recentGrids;  // ���ͼ��⣨���������100����
    constexpr double GRID_DUP_THRESHOLD = 0.010;  // ���ϸ񣺸�С�ľ��뼴��Ϊ�ظ�
    constexpr double GRID_DUP_PENALTY = 200.0;     // ���ͼ�ط�����Чʹ��200��
...
write_streaming_tiff:
    ...
    if (cfg.analyze && !analyzeScores.empty())
    {
        ...
        std::sort(worstIdx.rbegin(), worstIdx.rend());  // ���������ǰ
